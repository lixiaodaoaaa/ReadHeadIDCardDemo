...
public class ConfirmView extends View {
    ...
    //绘制偏移角度的动画时间
    private static final long NORMAL_CIRCLE_ANIMATION_DURATION = 1980L;
    //绘制×需要的path数量
    ...
    private int[] colors = {0XFF5FD896, 0XFF5FD896, 0XFF5FD896, 0XFF5FD896, 0XFF5FD896, 0XFF5FD896};
