...
/**
 * A pack of helpful getter and setter methods for reading/writing to
...
final public class SharedPrefsUtils{
     ...
     * @param key
     * @return The value from shared preferences, or null if the value could not
     * be read.
     */
     ...
     * @param key
     * @param value
     * @return true if the new value was successfully written to persistent
     * storage.
     */
    public static boolean setStringPreference(Context context, String key,
                                              String value){
        SharedPreferences preferences=PreferenceManager
                .getDefaultSharedPreferences(context);
     ...
     * storage.
     */
    public static boolean setBooleanPreference(Context context, String key,
                                               boolean value){
        SharedPreferences preferences=PreferenceManager
                .getDefaultSharedPreferences(context);
        if (preferences != null) {
