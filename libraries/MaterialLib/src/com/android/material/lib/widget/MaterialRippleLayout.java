...
import com.android.material.lib.R;
...
public class MaterialRippleLayout extends FrameLayout {
    ...
    private MaterialRippleLayoutCompat proxy;
    private Object radiusProperty;//Property<MaterialRippleLayout, Float>
    private Object circleAlphaProperty;//Property<MaterialRippleLayout, Integer>
    ...
    public MaterialRippleLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if ( Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            proxy = new MaterialRippleLayoutCompat(this);
            radiusProperty = proxy.radiusProperty;
            circleAlphaProperty = proxy.circleAlphaProperty;
        } else {
        /*
         * Animations
         */
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (!isEventInBounds) {
                        cancelPressedEvent();
                        if ( Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                            proxy.cancelHoverAnimator();
                        } else if (hoverAnimator != null) {
    ...
    private void startHover() {
        ...
        hoverAnimator = ObjectAnimator.ofFloat(this, (Property<MaterialRippleLayout, Float>)radiusProperty, rippleDiameter, radius)
    ...
    private void startRipple(final Runnable animationEndRunnable) {
        ...
        if ( Build.VERSION.SDK_INT < Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            proxy.startRipple(animationEndRunnable);
            return;
        }
        ...
        ObjectAnimator ripple = ObjectAnimator.ofFloat(this, (Property<MaterialRippleLayout, Float>)radiusProperty, radius, endRadius);
        ripple.setDuration(rippleDuration);
        ripple.setInterpolator(new DecelerateInterpolator());
        ObjectAnimator fade = ObjectAnimator.ofInt(this, (Property<MaterialRippleLayout, Integer>)circleAlphaProperty, rippleAlpha, 0);
    ...
    * Accessor
    ...
    public boolean getRippleDelayClick() {
        return this.rippleDelayClick;
    }
